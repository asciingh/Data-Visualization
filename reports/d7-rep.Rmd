...
```{r setup, echo=FALSE}
library("knitr")
include_graphics("../../../Desktop/School/Senior/Data Visualization/ME447-singhab/figures/d7-likert-atmbanking.png")
```
...
```{r setup2, echo=FALSE}
library("knitr")
include_graphics("../../../Desktop/School/Senior/Data Visualization/ME447-singhab/figures/d7-likert-onlinebanking.png")
```
